...
הפתעה חיובית במדד המחירים לצרכן בארה"ב העניקה רוח גבית לשווקים היום, כשגם המניות וגם האג"ח רשמו עליות על רקע היחלשות החששות מהעלאת ריבית קרובה מצד הפדרל ריזרב - למרות העלייה במחירי הנפט בעקבות המתיחות במזרח התיכון.

מדד S&P 500 עלה ב-0.2%, בעוד נאסד"ק התחזק ב-1%, בין היתר הודות לראלי במניות השבבים . בלטו במיוחד שתי מניות "זרות": אס.קיי. הייניקס  הדרום קוריאנית שהונפקה בשבוע שעבר והישראלית טאואר סמיקונדקטור .
...
מנגד, מניית IBM  צנחה בכ-24% לאחר שהחברה פספסה את תחזיות ההכנסות והזהירה כי לקוחות מפנים חלק מההשקעות ממוצרי תוכנה לטובת שבבים ושרתים.

בשוק האג"ח נרשמו עליות, בעיקר באג"ח הממשלתיות לטווחים הקצרים, לאחר שהמשקיעים הפחיתו את ההימורים על העלאת ריבית כבר בהחלטת הפד ביולי בעקבות נתוני האינפלציה המתונים.

במקביל, הנפט האמריקאי מחק את העליות החדות שנרשמו מוקדם יותר, לאחר שהנשיא דונלד טראמפ חזר בו מהכוונה להטיל אגרה על אוניות העוברות במצר הורמוז בתמורה להגנה צבאית אמריקאית.
...
מניית לוסיד   התאוששה חלקית לאחר שצללה מוקדם יותר בעד 55% , וכעת נסחרת בירידה של כ-20%, בעקבות דיווחים על אפשרות שהחברה תגיש בקשה להגנה מפני נושים.

בתגובה לפניית בלומברג הכחישה יצרנית הרכב החשמלי את השמועות והבהירה כי "הדיווחים על הגשת בקשה לפשיטת רגל אינם נכונים לחלוטין" .

לוסיד אישרה כי היא עובדת עם חברת הייעוץ AlixPartners , המתמחה בארגון מחדש של חברות, אך הדגישה כי תפקידה של החברה הוא לסייע בשיפור הביצועים התפעוליים , וכי היא לא המליצה על פתיחת הליך של פשיטת רגל.

מניות השבבים מובילות היום את השוק כשתעודת הסל SOXX  מזנקת, בולטות במיוחד שתי מניות "זרות": אס.קיי. הייניקס  הדרום קוריאנית שהונפקה בשבוע שעבר והישראלית טאואר סמיקונדקטור .
...
מגמה חיובית בוול סטריט לאחר שמדד המחירים לצרכן (CPI) לחודש יוני הפתיע כלפי מטה וחיזק את ההערכות שהפדרל ריזרב ינקוט קו פחות ניצי בהמשך השנה.
...
הבנקים הגדולים של וול סטריט פתחו את עונת הדוחות ברגל ימין, לאחר שג'יי.פי מורגן , בנק אוף אמריקה , סיטיגרופ, וולס פארגו וגולדמן זאקס  פרסמו תוצאות שעלו על תחזיות האנליסטים. הבנקים נהנו גם מהכנסות חזקות במיוחד מפעילות המסחר במניות.

הבנקים דיווחו  גם על זינוק חד בהכנסות מפעילות מסחר במניות, מגמה שהייתה משותפת לכל הגופים הגדולים ושיקפה את סביבת ה־ Risk On בשווקים - כלומר נכונות גבוהה יותר של משקיעים לקחת סיכונים ולהגדיל חשיפה למניות.

מנכ"ל ג'יי.פי מורגן, ג'יימי דיימון, אמר כי כל תחומי הפעילות המרכזיים של הבנק רשמו הכנסות שיא ברבעון. לדבריו, הכלכלה האמריקאית ממשיכה להפגין חוסן, על רקע השקעות עסקיות חזקות והמשך הגידול בתעסוקה. דיימון הוסיף כי הבינה המלאכותית כבר אפשרה לבנק לצמצם עד 40% מהמשרות בתפקידים מסוימים, אך רוב העובדים הועברו לתפקידים אחרים בתוך הארגון.

מנכ"ל בנק אוף אמריקה, בריאן מויניהאן, הגדיר את הרבעון כאחד החזקים בתולדות הבנק, וציין כי כל חטיבות הפעילות הציגו צמיחה דו-ספרתית ברווח הנקי ותשואה גבוהה על ההון. בהתייחס להשפעת הבינה המלאכותית על שוק העבודה אמר כי האחריות להתמודד עם השינויים מוטלת על הנהלות החברות.

גם בגולדמן זאקס הציגו תמונה אופטימית. המנכ"ל דייוויד סולומון אמר כי צבר העסקאות של הבנק הוא הגבוה ביותר בחמש השנים האחרונות, מה שעשוי לתמוך בצמיחת ההכנסות ברבעונים הבאים. לדבריו, הבינה המלאכותית צפויה בעיקר לשפר את פריון העובדים, ולא בהכרח להביא לצמצום במספר המשרות.

אחד האנליסטים שסיקר את גולדמן זאקס אף אמר כי "הייתה תחושה של חיוך משותף ברחוב", לנוכח ביצועי היתר של פעילות המסחר במניות והתוצאות החזקות שהציגו הבנקים בתחום.

מחירי הנפט מתמתנים, לאחר שנשיא ארה"ב דונלד טראמפ חזר בו מדרישתו להטיל אגרת הגנה של 20% על אוניות שיעברו במצר הורמוז בתמורה להגנה צבאית אמריקאית.

החוזים על הנפט האמריקאי מסוג WTI נסחרו בעלייה מתונה של 23 סנט לרמה של 78.5 דולר לחבית , בעוד שהחוזים על נפט ברנט עומדים על כ-84 דולר לחבית לאחר שמוקדם יותר עמדו על 88 דולר.
...
מוקדם יותר במהלך המסחר זינק מחיר ה-WTI מעל 80 דולר לחבית, על רקע העימות המתמשך בין ארה"ב לאיראן סביב השליטה במצר הורמוז. עם זאת, המחירים נסוגו לאחר הודעתו של טראמפ.

במקביל, פיקוד המרכז של צבא ארה"ב (CENTCOM) הודיע כי במהלך הלילה תקפו כוחות אמריקאיים מטרות צבאיות לאורך חופי איראן, במטרה לפגוע ביכולתה של טהרן לתקוף כלי שיט מסחריים באזור.
